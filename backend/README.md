...
## Project Structure
    ...
    ├── facebook_for_animal_33907  # Django project configurations
...
1. Clone this repo and `cd facebook_for_animal_33907`
...
2. Clone this repo and `cd facebook_for_animal_33907`
